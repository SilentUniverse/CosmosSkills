...
4. If **none** of the three exists yet, don't keep silent: say so once and offer to build the layer (`/domain-modeling` for the glossary, `/zoom-out --save` for the map) — then proceed either way.
