...
方法论原型借鉴自 mattpocock/skills——一套优秀的、为多人协作深度集成 GitHub 的英文世界工作流。CosmosSkills 针对单人本地开发做了彻底重裁：协作机制整体移除，issue 化为本地 markdown 队列（ready | done 两态，零外部依赖）；使用中文沟通并保留代码术语；并立法解决"AI 输出人类读不懂"的问题——面向人的报告突出结果、证据与待决定事项，详细日志按需读取。
