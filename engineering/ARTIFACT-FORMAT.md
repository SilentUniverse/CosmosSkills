...
configuration to repay a separate file. Single cards and PRDs alone do not require a profile. Cards with `contract_version: 3` reference it from `## 验证设计` via `- profile:
