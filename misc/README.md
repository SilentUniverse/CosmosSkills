...
- **[modern-cli-guardrails](./modern-cli-guardrails/SKILL.md)** — Set up a Claude Code PreToolUse hook that blocks legacy CLI tools (grep, find, cat, ls, sed) in Bash commands, hard-enforcing CLAUDE.md §7.
