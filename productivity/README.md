...
- **[grilling](./grilling/SKILL.md)** — The relentless interview engine: work the decision tree in rounds, asking the whole frontier at once each round. Auto-invoked on 'grill' triggers; `/grill` is the wrapper over it.
