...
- **[grilling](./grilling/SKILL.md)** — The relentless interview engine: walk every branch of the decision tree, one question at a time. Auto-invoked on 'grill' triggers; `grill` is the wrapper over it.
