...
description: >-
  Use when adding or repairing Husky pre-commit hooks, lint-staged formatting, commit-time type checking, or tests in a repository. Configures and verifies the repository-local commit gate.
