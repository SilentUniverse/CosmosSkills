...
| Tier | Blocks | Escape |
|---|---|---|
| Destructive Git | `reset --hard`, forced `clean`, `branch -D`, `checkout .`, `restore .` in host command position | none |
...
Quoted remote commands are data; host pipelines and command substitutions are executable host code.
