...
the two-axis rule — an existing line that already carries the fact is edited in place, never
duplicated; a `/map` refresh preserves them. Any other change regenerates the block
