...
name: conflicts
description: >-
  Use when a Git merge or rebase is in conflict, or when the user asks to resolve merge conflicts. Reconstructs each side's intent, preserves both where compatible, verifies the result, and completes only the authorized operation.
---
