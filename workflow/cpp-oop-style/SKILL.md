...
name: cpp-oop-style
description: >-
  Use when writing, editing, or reviewing C++ (.cpp/.h/.hpp/.cc/.cxx) or CMake:
  class/interface/API design; OOP and design patterns; RAII; dependency
  injection; project layout; dependencies; ABI; packaging/deployment. Overrides
  sloppy AI-default C++ even when no style is requested.
---
