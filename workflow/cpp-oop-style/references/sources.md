...
[`archibate/agent-skills`](https://github.com/archibate/agent-skills)
(`skills/cpp-oop-style`), whose original material is licensed
CC BY-NC-SA 4.0; the copy inherits that license for this directory.
Three host-conformance adjustments are made for this copy: the frontmatter
description (prefix and length) and two escaped slash tokens; everything else
is verbatim.
