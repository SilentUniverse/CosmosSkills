...
description: >-
  Use when defining domain terminology, ownership, or ubiquitous language, or when recording a qualifying architectural decision. Maintains the project's domain model in CONTEXT.md and ADRs when those surfaces exist.
---
